...
import { fetchCard, updateCard } from '../../../../Api/AdminAPI';
import BASE_URL from '../../../../config/config';

function EditMediaCard({ onClose, Id }) {
    ...
    useEffect(() => {
        const fetchMediaCard = async () => {
            try {
                ...
                const cardImages = cardData.images.map((image) => image.image);
            ...
            <div className="flex flex-col mx-auto max-w-screen-lg mt-10 bg-[#E8F5FF] shadow-lg">
                <div className="flex justify-between items-center mb-4 px-6 md:px-0 ">
                    ...
                    <div className=" text-center w-full">
                        <p className="py-1.5 pl-5 text-lg font-semibold text-blue-900">Edit Media Card</p>
                    </div>
                </div>
